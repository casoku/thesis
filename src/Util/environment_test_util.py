...
def place_obstacles(environment=None):
    ...
    environment.place_obj(obj = environment.obstacles[index], top = (4,5), size = (1, 1), max_tries=100)
    index += 1
    environment.obstacles.append(Ball())
    environment.place_obj(obj = environment.obstacles[index], top = (4,6), size = (1, 1), max_tries=100)
    index += 1
    # Room 2
    # environment.obstacles.append(Ball())
